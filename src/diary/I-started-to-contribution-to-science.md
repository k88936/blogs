---
date: 2025-9-1
title: I started to contribute to science
---
...
# 各种安装方案
## 1. 裸机直装
优点是可以利用显卡，archlinux的wiki说明也很详细。但是如果你在自己的user运行，下载的各种东西会把你的home弄乱。
## 2. docker
...
boinccmd --acct_mgr attach https://scienceunited.org/ name passwd 
```
## 添加 world community grid
```shell
# attach your application to World Community Grid
boinccmd --project_attach https://www.worldcommunitygrid.org auth
```
